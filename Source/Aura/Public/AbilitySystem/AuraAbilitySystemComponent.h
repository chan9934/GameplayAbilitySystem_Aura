...
DECLARE_MULTICAST_DELEGATE_TwoParams(FActivatePassiveEffect, const FGameplayTag& /*AbilityTag*/, bool /*Activate*/)
...
public:
	...
	void AddcCharacterAbilitiesFromSaveData(ULoadScreenSaveGame* SaveData);
