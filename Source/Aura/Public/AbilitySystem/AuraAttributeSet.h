...
public:
	...
	virtual void LoadAttribute(ACharacter* SourceAvatarActor, UAbilitySystemComponent* SourceASC, float Strength, float Intelligence, float Resilience, float Vigor);
